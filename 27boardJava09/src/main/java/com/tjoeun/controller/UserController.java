...
public class UserController {
  ...
  @GetMapping("/login")
  public String login(@ModelAttribute("validationLoginUserDTO") UserDTO userDTO) {
  	return "user/login";
  }
  
  @PostMapping("login_procedure")
  public String login_procedure(@Valid @ModelAttribute("validationLoginUserDTO") UserDTO userDTO, BindingResult result) {
